...
### P8 - 
O serviço de domínio (AddCashFlow) adiciona o id do fluxo de caixa registrado a key cash_flow_id para que seja validado e registardo futuramente como foreing key no registro do saldo na tabela cash_flow_balanses);
### P9 -
