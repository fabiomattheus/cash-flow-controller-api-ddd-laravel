...
## Contexto Delimitado
Este projeto é um contexto delimitado de fluxo de caixa, onde em novas versões, os dados dos funcionários e deparatamentos serão alimentados por outro projeto de Rh em outro contexto delimitado através de mensageria que, por sua vez, será desenvolvido em um microserviço a parte em .Net.  
...
### P3 - 
O Serviço de Dominio (GenerateIdentifier) gera um código único e faz um merge do mesmo com os dados da requisição (request);
### P4 - 
...
### P8 - 
O Serviço de Dominio (AddCashFlow) adiciona id do fluxo de caixa registrado a key cash_flow_id para que seja validado re registardo com fareing key no registro do saldo;
### P9 -
O serviço de aplicação (DelegateCashFlowAdd) delega ao serviço de dominio (AddCashFlowBalance) que atualize saldo; 
### P7 - 
serviço de dominio (AddCashFlowBalance) solicita ao repositório a adição do saldo do fluxo de caixa;
### P8 -
O reposiório registra os dados no banco de dados;  
### P9  -
O serviço de aplicação (DelegateCashFlowAdd) retorna um mensagem de sucesso para o usuário.
...
### P5 - 
O reposiório registra os dados pertinentes à atualização fluxo de caixa;
### P6 -
...
### P9  -
O serviço de aplicação (DelegateCashFlowUpdate) retorna um mensagem de sucesso para o usuário.
...
### P2 - 
O serviço de aplicação (DelegateCashFlowDelete) delega ao serviço de dominio (DeleteCashFlow) que delete o Fluxo de caixa pertinente ao id disponível na requisição (request), que, por sua vez, antes solictar a exclução, solicita ao Value Objeto IdVO a validação do id  disponível no request; 
### P3 - 
...
### P4 - 
O serviço de dominio (DeleteCashFlow) envia para o repositório o Value Object IdVO para obtero fluxo de caixa pertinente ao Id encapsulado no mesmo;
### P5 - 
...
### P1
O usuário envia para Api a data inicial, data Final, o tipo (Credito ou Débito) e pagina, para obeter todos o fluxos de caixa regitarado entre a data inicial à data final e o tipo;
### P2 - 
O serviço de dominio (FindAllCashFlowByDate) solicita ao Value Objeto DateVO a validação da data inicial, data final e ao Value Objeto TypeVO a validação tipo(Crédito ou Debito) disponível na requisição (request); 
### P3 - 
...
### P4 - 
O serviço de dominio (FindAllCashFlowByDate) envia para o repositório os Value Objects TypeVO, DateVo, o número da página e a limite (quantidade de itens a sererem paginados e obetidos) e os envia para o repositório;
### P5 - 
O reposiório retorna os fluxo de caixas;

### Fluxo de Exceção
### E1 -
O usuário envia para Api a data inicial invalida e/ou data final inválida e/ou tipo inválido e/ou número de pagina inválida para obeter os fluxos de caixa desejados
### E2 -
Api retorna uma mensagem de erro informando o ocorido.
...
### A3 - 
O TypeVo ao verificar que o tipo é nulo, adiona o valor 'all' para obter tanto fluxos de caixa do tipo crédito quanto fluxo de caixa do tipo débito e fica disponivel pra o serviço de dominio (FindAllCashFlowByDate) enviá-lo para o repositório;
### A4 - 
...
### A5 - 
O serviço de dominio (FindAllCashFlowByDate) envia para o repositório os Value Objects TypeVO, DateVo, página e o limite ( quantidade de itens a sererem paginados e obetidos) e os envia para o repositório;
### P5 - 
O reposiório retorna os fluxo de caixas;
