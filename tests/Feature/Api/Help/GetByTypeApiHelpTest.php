...
class GetByTypeApiHelpTest extends TestCase
{
    private  function findHelpByType(Help $help = null): TestResponse
    {
        return $this->getJson("/api/v1/help/find-by-type/{$help->type}", ['Accept' => 'application/json']);
    }
    ...
    {
        //Arrange
        $result = $this->findHelpByType($this->help)
            //Assert    
